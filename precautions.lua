...
init = function ( _parent  )
    ...
    nextPage = display.newText( _parent , "下一頁", _SCREEN.CENTER.X*0.74 , _SCREEN.CENTER.Y*1.9 , font , 20 )
...
showWebView = function (  )
    webView = native.newWebView( _SCREEN.CENTER.X , _SCREEN.CENTER.Y  , _SCREEN.W , 900*HEIGHT_RATIO )
    webView:request(url)
